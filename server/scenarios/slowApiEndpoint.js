module.exports = {
  ...
  difficulty: 'medium',
  timeLimit: 1800,
  brief: `Users are complaining that the /api/products endpoint is exceptionally slow (~4–5 seconds of latency). Initial diagnostics point to a database bottleneck. You have full access to inspect the logs and system states. Identify the hidden N+1 query issue.\n\n**Available Resources**\n- Service: Java Spring Boot API\n- Logs: logs/performance.log\n- DB query logs: logs/db.log`,
  commandMap: {
